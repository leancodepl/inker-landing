...
const painPoints = [
  {
    icon: (
      <svg fill="none" height="20" viewBox="0 0 20 20" width="20">
        <rect height="16" rx="4" stroke="#666" strokeWidth="1.5" width="16" x="2" y="2" />
        <circle cx="7" cy="10" fill="#666" r="1.5" />
        <circle cx="13" cy="10" fill="#666" r="1.5" />
        <path d="M7 14s1.5-1 3-1 3 1 3 1" stroke="#666" strokeLinecap="round" strokeWidth="1.5" />
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg fill="none" height="20" viewBox="0 0 20 20" width="20">
        <path d="M4 4h12v10H7l-3 3V4z" stroke="#666" strokeLinejoin="round" strokeWidth="1.5" />
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg fill="none" height="20" viewBox="0 0 20 20" width="20">
        <rect height="14" rx="2" stroke="#666" strokeWidth="1.5" width="14" x="3" y="3" />
        <path d="M3 8h14" stroke="#666" strokeWidth="1.5" />
        <path d="M7 3v5M13 3v5" stroke="#666" strokeLinecap="round" strokeWidth="1.5" />
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg fill="none" height="20" viewBox="0 0 20 20" width="20">
        <path d="M10 2L2 7v6l8 5 8-5V7l-8-5z" stroke="#666" strokeLinejoin="round" strokeWidth="1.5" />
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg fill="none" height="20" viewBox="0 0 20 20" width="20">
        ...
        <path d="M10 6v4l3 2" stroke="#666" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
      </svg>
    ),
